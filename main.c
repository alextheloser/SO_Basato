                ...
                if (isMissileVivo == 0) {
                    ...
                    switch (pid_missile1) {
                        case -1:
                            ...
                            exit(1);
                        case 0:
                            missile(pipeout, maxx, maxy, pos_navicella.x, pos_navicella.y, &isMissileVivo, 1); //missile che va in alto all'inizio
                        default:
                            pid_missile2=fork();
                            switch(pid_missile2){
                                case -1:
                                    ...
                                    exit(1);
                                case 0:
                                    missile(pipeout, maxx, maxy, pos_navicella.x, pos_navicella.y, &isMissileVivo, -1);
                                default:
                                    break;
                            }
                    }
